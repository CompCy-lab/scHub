...
from schub.data._utils import get_anndata_attribute
...
class BaseAnnDataField(ABC):
    ...
    def transfer_field(self, state_registry: dict, adata_target: AnnOrMuData, **kwargs) -> dict:
        """Transfer the registered field to a new `AnnData` object.
    ...
    def get_summary_stats(self, state_registry: dict) -> dict:
        """
        Returns a dictionary consisting of summary statistics relevant to the field.
