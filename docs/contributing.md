...
The scHub project follows the same guidelines as the [Scanpy's developer guide][scanpy developer guide].
This document provides a brief summary of the most important information to get you started on contributing.

We assume that you are already familiar with git and with making pull requests on GitHub. If not, please refer
to the [GitHub quickstart guide][github quickstart guide].
...
This package uses the [pytest][pytest-guide] for automated testing. Please add tests for new functions and bug fixes for
the package. If you are not familiar with writing tests, please refer to the [Scanpy's testing guide][scanpy-test-docs].
